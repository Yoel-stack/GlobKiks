    ...
    <div className="flex justify-center items-start px-4 py-8 mb-20">
      <div className="w-full max-w-4xl space-y-8 layerblack shadow-md rounded-md p-6">
        ...
        <div className="textslow mb-6">
          ...
          <p>{order.address.ciudad}, {order.address.pais} - CP: {order.address.codigoPostal}</p>
        ...
        <div className="mb-6 flex items-center space-x-2">
          <IoCardOutline
            ...
            size={24}
          />
          <p className={order.paid ? 'mt-3 text-green-600 font-semibold' : 'mt-3 text-red-600 font-semibold'}>
          ...
          {order.items && order.items.map((ci) => (
            ...
            >
              ...
              <div className="text-right">
                <p className="font-medium">${(ci.price * ci.quantity).toFixed(2)}</p>
              </div>
            </div>
          ))}
